  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(0, 51, 102, 0.8), rgba(0, 51, 102, 0.8)), url("/contact-bg.jpg")',
        }}
      >
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">123 Sports Street, Ichalkaranji, Maharashtra, India</p>
                  </div>
                </div>
